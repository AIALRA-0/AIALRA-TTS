...
TUNABLE_FIELDS: dict[str, dict[str, Any]] = {
    ...
    "tts.compact_distributed_max_gap_seconds": {"label": "紧凑配音最大间隔", "type": "float", "min": 0.2, "max": 4.0},
    "tts.prevent_audio_overlap": {"label": "防止配音重叠", "type": "bool"},
    "tts.min_audio_gap_seconds": {"label": "配音最小间隔秒数", "type": "float", "min": 0.0, "max": 1.0},
    "tts.shrink_delayed_slots_to_original_timeline": {"label": "延迟段按原时间轴收紧", "type": "bool"},
